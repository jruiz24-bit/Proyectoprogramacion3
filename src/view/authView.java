...
public class authView {
	...
	public void registro() {
	    ...
	    rgs_container.setBounds(300, 40, 420, 650); 
	    ...
	    JLabel subFullName = crearEtiqueta("NOMBRE COMPLETO", 155);
	    rgs_container.add(subFullName);
	    JTextField txtFullName = new JTextField();
	    txtFullName.setBounds(35, 185, 350, 30);
	    rgs_container.add(txtFullName);

	    
	    JLabel subPass = crearEtiqueta("CONTRASEÑA", 225);
	    rgs_container.add(subPass);
	    JPasswordField txtRegPass = new JPasswordField();
	    txtRegPass.setBounds(35, 255, 350, 30);
	    rgs_container.add(txtRegPass);

	   
	    JLabel subTerminos = crearEtiqueta("TÉRMINOS Y CONDICIONES", 315);
	    rgs_container.add(subTerminos);
	    JRadioButton rb1 = new JRadioButton("Acepto");
	    rb1.setBounds(40, 345, 100, 30);
	    rb1.setOpaque(false);
	    JRadioButton rb2 = new JRadioButton("Rechazo");
	    rb2.setBounds(150, 345, 100, 30);
	    rb2.setOpaque(false);
	    ...
	    JButton btnReg = new JButton("Registrar en BD");
	    btnReg.setBounds(60, 420, 300, 50);
	    ...
	    btnReg.addActionListener(e -> {
	        ...
	        if (user.isEmpty() || name.isEmpty() || pass.isEmpty() || !rb1.isSelected()) {
	            JOptionPane.showMessageDialog(ventana, "Por favor, llene todos los campos y acepte los términos.", "Advertencia", JOptionPane.WARNING_MESSAGE);
	            return;
	        }

	        
	        models.AuthModel auth = new models.AuthModel();
	        boolean success = auth.register(user, pass, name);

	        if (success) {
	            JOptionPane.showMessageDialog(ventana, "¡Usuario registrado con éxito!", "Éxito", JOptionPane.INFORMATION_MESSAGE);
	            ...
	            JOptionPane.showMessageDialog(ventana, "Error: El nombre de usuario ya existe o hubo un fallo de conexión.", "Error", JOptionPane.ERROR_MESSAGE);
	        }
	    });
	    rgs_container.add(btnReg);

	    JButton btnIrLogin = new JButton("Ya tengo cuenta. Ir a login");
	    btnIrLogin.setBounds(60, 500, 300, 30);
